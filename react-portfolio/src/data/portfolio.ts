...
export const personalInfo = {
  ...
  about: "I specialize in both frontend and backend development, with expertise in PHP, JavaScript, Vue.js, and advanced proficiency in Laravel. I enjoy collaborating in teams and embracing new technologies to deliver efficient projects.",
};
...
export const experienceTimeline = [
  {
    ...
    bullets: [
      "Contributed to the development of an AI-powered project, focusing on frontend implementation.",
      "Built user-friendly and responsive interfaces with React.js.",
      "Collaborated closely with backend engineers to integrate AI-driven features.",
    ],
  },
  {
...
export const projects = [
  {
    ...
    description:
      "An AI-powered automation platform where users can create many automation workflows from various SaaS like SalesForce, Google Drive and DropBox. I've involved as a frontend developer in building this platform.",

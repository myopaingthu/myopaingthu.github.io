          ...
          <div className="relative h-[600px] flex items-center justify-center">
            ...
            >
              <motion.img
                ...
                className="absolute top-[-115px] left-1/2 -translate-x-1/2 w-64 h-auto object-contain z-20"
              />
              <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 border border-white/10 rounded-2xl p-8 pt-16 shadow-2xl">
                {/* Code Window Header */}
